...
<body class="bg-gray-50 dark:bg-gray-900 font-inter h-[100dvh] overflow-hidden"> 
    ...
    <div class="app-container">
        ...
        <div id="sidebar" class="fixed top-0 left-0 h-full bg-white dark:bg-gray-800 z-50 transform -translate-x-full lg:translate-x-0 flex flex-col shadow-2xl lg:shadow-none transition-transform duration-300">
            ...
            <div class="p-4">
                <button id="logout-button" class="w-full bg-red-100 text-red-700 font-bold py-3 px-4 rounded-lg hover:bg-red-200 dark:bg-red-800 dark:text-red-100 dark:hover:bg-red-700 flex items-center justify-center"><i data-lucide="log-out" class="w-5 h-5 mr-2"></i><span>Log Out</span></button>
            </div>
        ...
        <div class="content-wrapper flex flex-col flex-grow h-full w-full bg-gray-50 dark:bg-gray-900">
            ...
            <main class="main-content bg-gray-50 dark:bg-gray-900 flex-grow overflow-y-auto pb-24 lg:pb-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-3 gap-4 mb-8">
                                <div class="glass-card p-4 rounded-xl text-center"><i data-lucide="leaf" class="w-8 h-8 text-green-500 mx-auto mb-2"></i><p id="impact-co2" class="font-bold text-lg dark:text-gray-100">0 kg</p><p class="text-xs text-gray-500 dark:text-gray-400">CO₂ Saved</p></div>
                            ...
                            <div class="glass-card border-l-4 border-blue-500 text-blue-700 dark:text-blue-300 p-4 rounded-xl" role="alert"><div class="flex"><div class="py-1"><i data-lucide="lightbulb" class="w-5 h-5 text-blue-500 mr-3"></i></div><div><p class="font-bold dark:text-blue-200">Unplug chargers!</p><p class="text-sm">Chargers and electronics still draw power even when not in use.</p></div></div></div>
                        </div>
                    </div>
                </div>
                ...
                <div id="about" class="page p-6">
                    ...
                    <div class="glass-card p-6 rounded-2xl space-y-4 max-w-3xl mx-auto"><p class="text-gray-600 dark:text-gray-300 leading-relaxed">Welcome to the Green Campus Challenge, an initiative by the College Green Club to promote sustainability and eco-friendly practices among students.</p><p class="text-gray-600 dark:text-gray-300 leading-relaxed">Our mission is to reduce our campus's carbon footprint through fun challenges, engaging events, and rewarding positive actions. Join us in making our campus a greener place, one EcoPoint at a time!</p></div>
                </div>

                <div id="help" class="page p-6">
                    <h2 class="text-3xl font-bold text-gray-900 dark:text-gray-100 mb-6">Help & Support</h2>
                    <div class="glass-card p-6 rounded-2xl space-y-4 max-w-3xl mx-auto">
                        <h3 class="text-xl font-bold text-gray-900 dark:text-gray-100">Frequently Asked Questions</h3>
                        <div class="text-left space-y-4 text-sm">
                            <div><p class="font-semibold text-gray-800 dark:text-gray-200">How do I earn points?</p><p class="text-gray-600 dark:text-gray-300">You can earn EcoPoints by participating in events, completing challenges, and logging your eco-friendly activities.</p></div>
                            <div><p class="font-semibold text-gray-800 dark:text-gray-200">How do I redeem rewards?</p><p class="text-gray-600 dark:text-gray-300">Navigate to the 'Store' tab to purchase a reward. Then, go to 'Orders' to find your active coupons and redeem them.</p></div>
                        </div>
                        <div class="border-t dark:border-gray-700 pt-6 mt-6"><h3 class="text-xl font-bold text-gray-900 dark:text-gray-100">Contact Us</h3><p class="text-gray-600 dark:text-gray-300 mt-2">For further assistance, please email us at <a href="#" class="text-green-600 dark:text-green-400 font-medium">support@greencampus.edu</a>.</p></div>
                    </div>
                </div>
            </main>
    ...
    <button onclick="openChatbotModal()" id="chatbot-btn" class="fixed z-30 bottom-24 lg:bottom-10 right-6 w-16 h-16 flex items-center justify-center hover:scale-105 transition-transform"><img src="https://i.ibb.co/7xwsMnBc/Pngtree-green-earth-globe-clip-art-16672659-1.png" alt="EcoBot" class="w-full h-full object-contain drop-shadow-xl"></button>
